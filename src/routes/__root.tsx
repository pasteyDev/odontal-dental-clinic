          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@graph": [
                {
                  "@type": "LocalBusiness",
                  "@id": (typeof window !== 'undefined' ? window.location.origin : (import.meta.env.VITE_PUBLIC_SITE_URL || "")),
                  "name": CLINIC.name,
                  ...
                  "url": (typeof window !== 'undefined' ? window.location.origin : (import.meta.env.VITE_PUBLIC_SITE_URL || "")),
